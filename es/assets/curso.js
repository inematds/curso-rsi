...
(function(){
  ...
  var L={"lido": "leído", "concluida": "completada ✓", "andamento": "en progreso", "comecar": "empezar →", "continuar": "Continuar desde donde te quedaste", "comecarCurso": "Empezar por la lección 1", "revisao": "Revisar", "aula": "Lección", "revisarN": "revisar {n}", "aulasConcluidas": "lecciones completadas", "faltam": "para terminar", "min": "min", "dica": "Consejo: el botón <b>Aa</b> aumenta la letra. Tu progreso se guarda solo en este navegador.", "entendi": "entendí", "promessa": "Al final de esta lección", "fechoTit": "Cerrar la lección", "fechoTxt": "En una frase: ¿qué de esta lección vas a usar primero en tu trabajo? (opcional, solo para ti)", "concluir": "concluir la lección", "concluidaTit": "Lección concluida.", "concluidaTxt": "{n} preguntas de esta lección fueron a <b>revisar</b>. Vuelven solas en los próximos días, a la hora exacta de acordarte.", "salvo": "Tu progreso fue guardado.", "revisarAgora": "revisar ahora", "refazer": "repetir la práctica", "mostrar": "mostrar respuesta", "deNovo": "me equivoqué", "bom": "lo recordé", "facil": "fácil", "nadaRevisar": "No hay nada para revisar ahora. Las preguntas vuelven solas en los próximos días.", "menu": "Menú", "trilhas": "Rutas", "trilhasSub": "elegir el módulo", "jornada": "Mi jornada", "exercicios": "Prácticas del curso", "tema": "Tema", "idioma": "Idioma", "temas": {"papel": "papel", "escuro": "oscuro", "sepia": "sepia"}, "tamanho": "Tamaño de la letra", "entrelinha": "Espacio entre líneas", "restaurar": "restaurar el valor predeterminado", "fechar": "cerrar", "menor": "menor", "maior": "mayor", "menos": "menos", "mais": "más", "jProg": "Progreso", "jCap": "Lo que ya puedes hacer", "jCapVazio": "Todavía no hay ninguna lección completada — está bien, una cosa a la vez.", "jTempo": "Tiempo", "investido": "invertido", "restante": "restante", "jGrifos": "Tus subrayados", "jSemGrifo": "Todavía no hay subrayados. Selecciona un fragmento del texto para subrayar.", "jPend": "sin prisa — {n} preguntas esperando por ti", "jPend0": "nada esperando por ti ahora", "jFim": "Terminaste toda la ruta. Lo que estaba en el papel ahora está en tu trabajo.", "capRe": "^(al final de esta lección,? )?(ya )?(puedes|podrás|tienes|tendrás) ", "exportar": "guardar mi progreso (.json)", "importar": "traer progreso guardado", "zerar": "poner todo en cero", "zerarQ": "¿Borrar todo tu progreso de este curso?", "arqInv": "Archivo inválido.", "irAte": "ir hasta ella", "resetar": "rehacer", "feito": "hecha", "pendente": "pendiente", "grifar": "subrayar", "grifarCartao": "subrayar + pregunta", "novoCartao": "Nueva pregunta de repaso", "frente": "Pregunta", "verso": "Respuesta", "ceHint": "Escribe como <b>pregunta</b>: recordar solo fija más que releer.", "salvar": "guardar", "cancelar": "cancelar", "copiar": "copiar", "copiado": "copiado ✓", "certo": "Correcto.", "quase": "Casi.", "aCerta": "La correcta está marcada.", "exemplo": "En la práctica", "compare": "Toca para comparar los dos casos:", "glossario": "Glosario", "verGlossario": "ver en el glosario"};
  /*L-FIM*/
