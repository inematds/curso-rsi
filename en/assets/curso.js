...
(function(){
  ...
  var L={"lido": "read", "concluida": "completed ✓", "andamento": "in progress", "comecar": "start →", "continuar": "Continue from where you left off", "comecarCurso": "Start with Lesson 1", "revisao": "Review", "aula": "Lesson", "revisarN": "review {n}", "aulasConcluidas": "lessons completed", "faltam": "to finish", "min": "min", "dica": "Tip: the <b>Aa</b> button increases the font size. Your progress is saved automatically in this browser.", "entendi": "I got it", "promessa": "At the end of this lesson", "fechoTit": "Close the lesson", "fechoTxt": "In one sentence: what from this lesson will you use first at work? (optional, just for you)", "concluir": "complete lesson", "concluidaTit": "Lesson completed.", "concluidaTxt": "{n} questions from this lesson were sent to <b>review</b>. They come back by themselves over the next few days, at the right time to remember.", "salvo": "Your progress was saved.", "revisarAgora": "review now", "refazer": "redo the practice", "mostrar": "show answer", "deNovo": "I got it wrong", "bom": "I remembered", "facil": "easy", "nadaRevisar": "Nothing to review right now. The questions come back by themselves over the next few days.", "menu": "Menu", "trilhas": "Tracks", "trilhasSub": "choose the module", "jornada": "My journey", "exercicios": "Course practices", "tema": "Topic", "idioma": "Language", "temas": {"papel": "paper", "escuro": "dark", "sepia": "sepia"}, "tamanho": "Font size", "entrelinha": "Line spacing", "restaurar": "restore default", "fechar": "close", "menor": "smaller", "maior": "larger", "menos": "less", "mais": "more", "jProg": "Progress", "jCap": "What you can already do", "jCapVazio": "Still no lessons completed — that's okay, one at a time.", "jTempo": "Time", "investido": "invested", "restante": "remaining", "jGrifos": "Your highlights", "jSemGrifo": "No highlights yet. Select a passage from the text to highlight.", "jPend": "no rush — {n} questions waiting for you", "jPend0": "nothing waiting for you right now", "jFim": "You completed the entire track. What was on paper is now in your work.", "capRe": "^(by the end of this lesson,? )?you (can|will be able to|have|will have) ", "exportar": "save my progress (.json)", "importar": "bring saved progress", "zerar": "reset everything", "zerarQ": "Clear all your progress in this course?", "arqInv": "Invalid file.", "irAte": "go to it", "resetar": "redo", "feito": "made", "pendente": "pending", "grifar": "highlight", "grifarCartao": "highlight + question", "novoCartao": "New review question", "frente": "Question", "verso": "Answer", "ceHint": "Write as <b>question</b>: remembering it alone sticks better than rereading.", "salvar": "save", "cancelar": "cancel", "copiar": "copy", "copiado": "copied ✓", "certo": "That’s right.", "quase": "Almost.", "aCerta": "The correct one is marked.", "exemplo": "In practice", "compare": "Tap to compare the two cases:", "glossario": "Glossary", "verGlossario": "see in the glossary"};
  /*L-FIM*/
